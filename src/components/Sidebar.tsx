            ...
            <div className="space-y-0.5 mt-1">
              ...
              <button
                ...
                className={`
                  w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg
                  transition-all duration-200 ease-out cursor-pointer
                  ${pathname === '/vault' ? '' : 'hover:bg-black/5 dark:hover:bg-white/5'}
                `}
                style={{
                  background: pathname === '/vault' ? 'var(--accent-gradient-subtle)' : undefined,
                  color: pathname === '/vault' ? 'var(--accent-primary)' : 'var(--foreground-secondary)',
                }}
              >
